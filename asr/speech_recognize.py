...
pid = 'YOUR_PID_GOES_HERE'  # 'YOUR_PID_GOES_HERE'
secret_key = b'YOUR_SECRETKEY_GOES_HERE'  # b'YOUR_SECRETKEY_GOES_HERE'
endpoint_host = 'asr.ilivedata.com'
endpoint_path = '/api/v1/speech/recognize'
endpoint_url = 'https://asr.ilivedata.com/api/v1/speech/recognize'


def recognize(audio, language_code, user_id, profanity_filter):
...
if __name__ == '__main__':
    ...
    response = recognize(audio_base64, 'zh-CN', '12345678', 1)
    print(response)
    response = recognize(audio_base64, 'zh-CN', '12345678', 0)
    print(response)
