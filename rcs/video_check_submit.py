...
endpoint_path = '/api/v1/video/check/submit'
endpoint_url = 'https://vsafe.ilivedata.com/api/v1/video/check/submit'
...
if __name__ == '__main__':
    video_url = "http://edge.ivideo.sina.com.cn/34463529803.mp4?KID=sina,viask&Expires=1597852800&ssig=6po29lqbTn&reqid="
